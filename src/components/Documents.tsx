...
const documents = [
  {
    ...
    type: "PDF",
    link: "https://drive.google.com/drive/folders/1BO2WCTY3XsxYCKy8CC82owoQzeNVwSq9?usp=drive_link",
  },
  {
    ...
    icon: DocumentTextIcon,
    type: "PDF",
    link: "https://drive.google.com/drive/folders/1XvJEx36ppeEONyiLOhwYdOf5sPrxodH5?usp=drive_link",
  },
  {
    title: "Final Reports",
    ...
    icon: DocumentTextIcon,
    type: "PDF",
    link: "https://drive.google.com/drive/folders/1pN_xwDz7PNUyvGpVhi6UI0QDcjtxiFFI?usp=drive_link",
  },
  {
    ...
    icon: DocumentTextIcon,
    type: "PDF",
    link: "https://drive.google.com/drive/folders/18-NoRrSAoWnkkOFVDufpGZS53q0suJSO?usp=drive_link",
  },
];
...
const presentations = [
  {
    ...
    type: "Slides",
    link: "https://drive.google.com/drive/folders/1pDywrh9ct1rgckNjHTdoFL7FsxaLlvQc?usp=drive_link",
  },
  {
    ...
    icon: PresentationChartBarIcon,
    type: "Slides",
    link: "https://drive.google.com/drive/folders/1ZilRamMTW5jjSzEJru1ZeDfMujPxKv1c?usp=drive_link",
  },
  {
    ...
    icon: PresentationChartBarIcon,
    type: "Slides",
    link: "https://drive.google.com/drive/folders/1upBPQtBv7j1Zl1IlK3IqG4jHLM--EeG8?usp=drive_link",
  },
  {
    ...
    icon: PresentationChartBarIcon,
    type: "Slides",
    link: "https://drive.google.com/drive/folders/1v6A4IqJsZXqcZQKbpvBBhnlIURYOvfYk?usp=drive_link",
  },
];
